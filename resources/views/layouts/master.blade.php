                        ...
                        <div class="collapse navbar-collapse mt-3 mt-xl-0" id="primaryMenu02">
                            ...
                            <div class="d-block d-xl-none">
                                <ul
                                    ...
                                    <a class="dropdown-item @if (App::isLocale('en')) active @endif" href="{{ url('/language/en')}}">EN</a>
                                    <a class="dropdown-item @if (App::isLocale('ar')) active @endif" href="{{ url('/language/ar')}}">AR</a>
                                        </div>
                                    </li>
                                    <li class="divider"></li>
                                </ul>
