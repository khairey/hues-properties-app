...
<span class="text-white fs-24"><i class="fal fa-bars"></i></span>
    ...
    Dashboard
                                      ...
                                      <li class="dropdown-item">
                                          <a id="navbar-link-add-new-property" class="dropdown-link" href="dashboard-add-new-property.html">
    Add New Property
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-my-properties" class="dropdown-link" href="dashboard-my-properties.html">
    My Properties
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-my-favorites" class="dropdown-link" href="dashboard-my-favorites.html">
    My Favorites
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-save-search" class="dropdown-link" href="dashboard-save-search.html">
    Save Search
    </a>
                                      </li>
                                      <li class="dropdown-item">
    ...
    Reviews
                                      ...
                                      <li class="dropdown-item">
                                          <a id="navbar-link-my-package" class="dropdown-link" href="dashboard-my-packages.html">
    My Package
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-my-profile" class="dropdown-link" href="dashboard-my-profiles.html">
    My Profile
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-signup-and-login" class="dropdown-link" href="signup-and-login.html">
    Signup and login
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-password-recovery" class="dropdown-link" href="password-recovery.html">
    Password Recovery
    </a>
                                      </li>
                                  </ul>
    ...
    <span class="caret"></span>
                                  ...
                                  <ul class="dropdown-menu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-item-pages">
                                      <li class="dropdown-item dropdown dropright">
                                          <a id="navbar-link-news" class="dropdown-link dropdown-toggle" href="#" data-toggle="dropdown">
    News
    </a>
    ...
    About us
                                      ...
                                      <li class="dropdown-item dropdown dropright">
                                          <a id="navbar-link-service" class="dropdown-link dropdown-toggle" href="#" data-toggle="dropdown">
    Service
    </a>
                                          <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-link-service">
                                              <li class="dropdown-item">
                                      ...
                                      <li class="dropdown-item dropdown dropright">
                                          <a id="navbar-link-contact-us" class="dropdown-link dropdown-toggle" href="#" data-toggle="dropdown">
    Contact us
    </a>
                                          <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-link-contact-us">
                                              <li class="dropdown-item">
                                      ...
                                      <li class="dropdown-item dropdown dropright">
                                          <a id="navbar-link-agent" class="dropdown-link dropdown-toggle" href="#" data-toggle="dropdown">
    Agent
    </a>
                                          <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-link-agent">
                                              <li class="dropdown-item">
                                      ...
                                      <li class="dropdown-item dropdown dropright">
                                          <a id="navbar-link-agency" class="dropdown-link dropdown-toggle" href="#" data-toggle="dropdown">
    Agency
    </a>
                                          <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-link-agency">
                                              <li class="dropdown-item">
    ...
    Page 404
                                      ...
                                      <li class="dropdown-item">
                                          <a id="navbar-link-checkout" class="dropdown-link" href="checkout-complete-1.html">
    Checkout
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                          <a id="navbar-link-payment-completed" class="dropdown-link" href="checkout-complete-2.html">
    Payment Completed
    </a>
                                      </li>
                                      <li class="dropdown-item">
                                      ...
                                      <div class="dropdown-body">
                                          ...
                                          <a class="dropdown-item py-1" href="docs/getting-started/changelog.html">
                                              <div class="media">
                                                  ...
                                                  <div class="media-body">
                                                      <span class="d-block lh-15">Changelog<span class="badge badge-success ml-2">v1.0.1</span></span>
...
hide</a>
                ...
                <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                    ...
                    <p class="font-weight-500 text-muted lh-184">Lorem ipsum dolor sit amet, consecte tur cing elit. Suspe ndisse suscipit sagittis </p>
                    <form>
