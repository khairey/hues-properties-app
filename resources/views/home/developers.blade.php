                    ...
                    <div class="form-group mb-3 mb-lg-0 col-md-5">
                        ...
                        <div class="input-group input-group-sm">
                            <input type="text" id="search" class="form-control pl-0 rounded-0 bg-white"
                                placeholder="Search by developer’s name…" name="search">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 mb-6">
                    <div class="card px-6">
                        <a class="card-img-top" href="developers-details-1.html">
                            <img src="images/agency-grid-02.jpg" alt="Eco House Company">
                        </a>
                        <div class="card-body px-0 pt-2 pb-6 border-top">
                            <a href="developers-details-1.html">
                                <h6 class="text-dark lh-213 mb-0 hover-primary">Eco House Company</h6>
                ...
                <div class="col-sm-6 col-md-4 mb-6">
                    <div class="card px-6">
                        <a class="card-img-top" href="developers-details-1.html">
                            <img src="images/agency-grid-03.jpg" alt="Eco House Company">
                        </a>
                        <div class="card-body px-0 pt-2 pb-6 border-top">
                            <a href="developers-details-1.html">
                                <h6 class="text-dark lh-213 mb-0 hover-primary">Eco House Company</h6>
