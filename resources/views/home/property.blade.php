                ...
                <form class="search-form d-none d-lg-block">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-5 pt-lg-0 pt-6">
                            <label
                                class="text-uppercase font-weight-500 opacity-7 text-white letter-spacing-093">Search</label>
                    ...
                    <article class="col-lg-8">
                        <section class="pb-8 px-6 pt-6 bg-white rounded-lg">
                            <ul class="list-inline d-sm-flex align-items-sm-center mb-2">
                                ...
                                <li class="list-inline-item mr-2 mt-2 mt-sm-0"><i class="fal fa-clock mr-1"></i>2 months
                                    ago
                                </li>
                            ...
                            <div class="d-sm-flex justify-content-sm-between">
                                <div>
                                    ...
                                    <p class="mb-0"><i class="fal fa-map-marker-alt mr-2"></i>398 Pete Pascale
                                        Pl,
                                        New York</p>
                                </div>
                            ...
                            <p class="mb-0 lh-214">Massa tempor nec feugiat nisl pretium. Egestas fringilla phasellus
                                ...
                                eu mi bibendum neque egestas congue quisque. Sed elementum tempus egestas sed sed risus
                                pretium
                                ...
                                <div class="card border-0 shadow-xxs-5 bg-gray-01">
                                    <div class="card-header bg-gray-01 border-gray border-0 p-0" id="floor-plans-02">
                                        <div class="heading bg-gray-01 d-flex justify-content-between align-items-center px-6"
                                            ...
                                            <h2 class="mb-0 fs-16 text-heading font-weight-500 py-4 lh-13">Second Floor
                                            </h2>
                                            <ul class="list-inline mb-0 d-none d-sm-block pr-2">
                                                <li class=" list-inline-item text-muted mr-4">Beds : <span
                                                        class="font-weight-500 text-heading">2</span></li>
                                        ...
                                        <div class="tab-content pt-1 pb-0 px-0 shadow-none">
                                            <div class="tab-pane fade active show" id="schedule" role="tabpanel">
                                                <div class="delivery d-flex font-weight-normal s-small my-2">
                                                    <div class="item text-center font-weight-bold p-1 px-3">Down <br> Payment <div
                                                            class="lg-font value text-main font-weight-bold text-primary">10%</div>
                                                    </div>
                                                    <div class="item text-center font-weight-bold p-1  px-3">Installments <br> Years<div
                                                            class="lg-font value text-main font-weight-bold text-primary"> 9</div>
                                                    </div>
                                                    <div class="item text-center font-weight-bold p-1 px-3">Delivery <br> date<div
                                                            class="lg-font value text-main font-weight-bold text-primary">2024</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane fade pt-5" id="request-info" role="tabpanel">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-primary btn-lg btn-block rounded">Request Info</button>
