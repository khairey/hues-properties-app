    ...
    <section class="pb-8 page-title shadow">
      <div class="container">
        <nav aria-label="breadcrumb">
          ...
          <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600">Grid With Right Filter</h1>
        </nav>
      </div>
    </section>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-6">
                <div class="card border-0" data-animate="fadeInUp">
                  ...
                  <div class="card-body pt-3 px-0 pb-1">
                    <h2 class="fs-16 mb-1"><a href="single-property-1.html" class="text-dark hover-primary">Villa on
              ...
              <div class="col-md-6 mb-6">
                <div class="card border-0" data-animate="fadeInUp">
                  ...
                  <div class="card-body pt-3 px-0 pb-1">
                    <h2 class="fs-16 mb-1"><a href="single-property-1.html" class="text-dark hover-primary">Affordable
                        Urban House</a>
                    </h2>
                    <p class="font-weight-500 text-gray-light mb-0">1421 San Pedro St, Los Angeles</p>
                    <p class="fs-17 font-weight-bold text-heading mb-0 lh-16">
              ...
              <div class="col-md-6 mb-6">
                <div class="card border-0" data-animate="fadeInUp">
                  ...
                  <div class="card-body pt-3 px-0 pb-1">
                    <h2 class="fs-16 mb-1"><a href="single-property-1.html" class="text-dark hover-primary">Explore Old
                        Barcelona</a>
                    </h2>
                    <p class="font-weight-500 text-gray-light mb-0">1421 San Pedro St, Los Angeles</p>
                    <p class="fs-17 font-weight-bold text-heading mb-0 lh-16">
              ...
              <div class="col-md-6 mb-6">
                <div class="card border-0" data-animate="fadeInUp">
                  ...
                  <div class="card-body pt-3 px-0 pb-1">
                    <h2 class="fs-16 mb-1"><a href="single-property-1.html" class="text-dark hover-primary">Garden
                        Gingerbread House</a>
                    </h2>
                    <p class="font-weight-500 text-gray-light mb-0">1421 San Pedro St, Los Angeles</p>
                    <p class="fs-17 font-weight-bold text-heading mb-0 lh-16">
                ...
                <div class="card-body pl-0 pl-lg-6 pr-0 pt-2 pb-4">
                  ...
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Location"
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="All Types"
                        data-style="btn-lg py-2 h-52" id="type">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="All Status"
                    ...
                    <div class="form-row mb-4">
                      <div class="col">
                        ...
                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Beds"
                          data-style="btn-lg py-2 h-52" id="bed">
                          <option>3</option>
                          <option>4</option>
                        </select>
                      </div>
                      <div class="col">
                        ...
                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Baths"
                          data-style="btn-lg py-2 h-52" id="baths">
                          <option>3</option>
                          <option>4</option>
                        </select>
                      </div>
